	...
	<div>
		<div class="header">
			...
			<div class="context">
				...
				<h3>代理商&amp;分销员数据报告</h3>
				<p>氢量极品自2018年6月1日上线以来，累积帮助1000余人改善了自己的肤质，收集真实客户案例50余例。</p>
		...
		<div class="section">
			...
			<div class="section-bd">
				...
				<div class="cooperatives">
					...
					<p>兹有北京日新康百科贸有限公司为大中华区固体负氢元素总代理商，开发的每日氢元素、肤活素、氢素护肤、H301等品牌产品为了市场的全面开拓与运营，经协商达成共识与品牌经营渠道领先的普朗瑞斯(北京)健康科技有限公司、网络推广销售国内优秀企业的广西草盟网络科技有限公司达成战略合作协议，建立统一销售渠道"。委托广西草盟网络科技有限公司作为运营主体对外统一授权及协调运作事宜。</p>
				</div>
			</div>
		</div>			
	</div>
